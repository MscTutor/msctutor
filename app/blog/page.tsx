...
export const metadata: Metadata = {
  ...
  description: 'Educational articles, study tips, exam strategies and learning resources for Class 1-12 students.',
    ...
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      {posts.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '4rem', color: '#6b7280' }}>
          <div style={{ fontSize: 56 }}>Articles</div>
          <h2 style={{ fontSize: 20, marginTop: '1rem' }}>Educational article space is ready</h2>
          <p>Blog publishing will start automatically after database content is connected.</p>
        </div>
      ) : (
